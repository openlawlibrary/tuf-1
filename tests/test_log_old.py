...
class TestLog(unittest.TestCase):
    ...
    def test_set_log_level(self):
        ...
        self.assertRaises(
            securesystemslib.exceptions.FormatError, tuf.log.set_log_level, 51
        )
    ...
    def test_set_filehandler_log_level(self):
        ...
        # set the log level.
        self.assertRaises(
            tuf.exceptions.Error, tuf.log.set_filehandler_log_level
        )
    ...
    def test_set_console_log_level(self):
        ...
        self.assertRaises(
            securesystemslib.exceptions.Error, tuf.log.set_console_log_level
        )
