...
class TestRoledb(unittest.TestCase):
    ...
    def test_clear_roledb(self):
        ...
        self.assertEqual(
            roleinfo["keyids"],
            tuf.roledb.get_role_keyids(rolename, repository_name),
        )
    ...
    def test_role_exists(self):
        ...
        tuf.roledb.create_roledb(repository_name)
        self.assertEqual(
            False, tuf.roledb.role_exists(rolename, repository_name)
        )
        tuf.roledb.add_role(rolename, roleinfo, repository_name)
        ...
        self.assertRaises(
            securesystemslib.exceptions.FormatError, tuf.roledb.role_exists, 123
        )
        self.assertRaises(
            securesystemslib.exceptions.FormatError,
            tuf.roledb.role_exists,
    ...
    def test_remove_role(self):
        ...
        roleinfo2 = {
            ...
            "delegations": {
                "roles": [
                    {"name": "django", "keyids": ["456"], "threshold": 1}
                ],
                "keys": {
                    "456": {"keytype": "rsa", "keyval": {"public": "456"}},
                },
            },
        }
        ...
        self.assertEqual(
            None, tuf.roledb.remove_role(rolename, repository_name)
        )
    ...
    def test_get_rolenames(self):
        ...
        tuf.roledb.add_role(rolename2, roleinfo)
        self.assertEqual(
            set(["targets", "role1"]), set(tuf.roledb.get_rolenames())
        )
    ...
    def test_get_role_info(self):
        ...
        self.assertRaises(
            tuf.exceptions.UnknownRoleError, tuf.roledb.get_roleinfo, rolename
        )
        tuf.roledb.add_role(rolename, roleinfo)
        tuf.roledb.add_role(rolename2, roleinfo2)
    ...
    def test_get_role_keyids(self):
        ...
        tuf.roledb.add_role(rolename, roleinfo, repository_name)
        self.assertEqual(
            ["123"], tuf.roledb.get_role_keyids(rolename, repository_name)
        )
    ...
    def test_get_role_threshold(self):
        ...
        self.assertEqual(
            roleinfo["threshold"],
            tuf.roledb.get_role_threshold(rolename, repository_name),
        )
    ...
    def test_get_role_paths(self):
        ...
        self.assertRaises(
            tuf.exceptions.UnknownRoleError, tuf.roledb.get_role_paths, rolename
        )
        tuf.roledb.add_role(rolename, roleinfo)
        tuf.roledb.add_role(rolename2, roleinfo2)
        ...
        self.assertEqual(
            roleinfo2["paths"],
            tuf.roledb.get_role_paths(rolename2, repository_name),
        )
    ...
    def test_get_delegated_rolenames(self):
        ...
        roleinfo2 = {
            ...
            "delegations": {
                "roles": [
                    {"name": "release", "keyids": ["789"], "threshold": 1}
                ],
                "keys": {
                    "789": {"keytype": "rsa", "keyval": {"public": "789"}},
                },
            },
        }
        ...
        self.assertEqual(
            set(["release"]), set(tuf.roledb.get_delegated_rolenames(rolename2))
        )

        self.assertEqual(
            set([]), set(tuf.roledb.get_delegated_rolenames(rolename3))
        )

        self.assertEqual(
            set([]), set(tuf.roledb.get_delegated_rolenames(rolename4))
        )
    ...
    def test_create_roledb_from_root_metadata(self):
        ...
        self.assertEqual(
            [keyid], tuf.roledb.get_role_keyids("root", repository_name)
        )
        self.assertEqual(
            [keyid2], tuf.roledb.get_role_keyids("targets", repository_name)
        )
    ...
    def test_update_roleinfo(self):
        ...
        tuf.roledb.update_roleinfo(
            rolename, roleinfo, mark_role_as_dirty, repository_name
        )
        self.assertEqual(
            roleinfo["keyids"],
            tuf.roledb.get_role_keyids(rolename, repository_name),
    ...
    def test_get_dirty_roles(self):
        ...
        tuf.roledb.update_roleinfo(
            rolename, roleinfo2, mark_role_as_dirty, repository_name
        )
        self.assertEqual(
            [rolename], tuf.roledb.get_dirty_roles(repository_name)
        )
    ...
    def _test_rolename(self, test_function):
        ...
        # Test conditions where the arguments are improperly formatted.
        self.assertRaises(
            securesystemslib.exceptions.FormatError, test_function, None
        )
        self.assertRaises(
            securesystemslib.exceptions.FormatError, test_function, 123
        )
        self.assertRaises(
            securesystemslib.exceptions.FormatError, test_function, ["rolename"]
        )
        self.assertRaises(
            securesystemslib.exceptions.FormatError, test_function, {"a": "b"}
        )
        self.assertRaises(
            securesystemslib.exceptions.FormatError, test_function, ("a", "b")
        )
        self.assertRaises(
            securesystemslib.exceptions.FormatError, test_function, True
        )

        # Test condition where the 'rolename' has not been added to the role database.
        self.assertRaises(
            tuf.exceptions.UnknownRoleError, test_function, "badrole"
        )

        # Test conditions for invalid rolenames.
        self.assertRaises(
            securesystemslib.exceptions.InvalidNameError, test_function, ""
        )
        self.assertRaises(
            securesystemslib.exceptions.InvalidNameError,
            test_function,
