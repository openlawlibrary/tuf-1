...
class TestKeydb(unittest.TestCase):
    ...
    def test_remove_keydb(self):
        ...
        self.assertRaises(
            securesystemslib.exceptions.FormatError, tuf.keydb.remove_keydb, 123
        )
    ...
    def test_clear_keydb(self):
        ...
        self.assertRaises(
            securesystemslib.exceptions.FormatError, tuf.keydb.clear_keydb, 0
        )
        self.assertRaises(
    ...
    def test_get_key(self):
        ...
        self.assertRaises(
            securesystemslib.exceptions.FormatError, tuf.keydb.get_key, None
        )
        self.assertRaises(
            securesystemslib.exceptions.FormatError, tuf.keydb.get_key, 123
        )
        self.assertRaises(
            securesystemslib.exceptions.FormatError, tuf.keydb.get_key, ["123"]
        )
        ...
        self.assertRaises(
            securesystemslib.exceptions.FormatError, tuf.keydb.get_key, ""
        )
        self.assertRaises(
            securesystemslib.exceptions.FormatError,
            tuf.keydb.get_key,
        ...
        keyid3 = KEYS[2]["keyid"]
        self.assertRaises(
            tuf.exceptions.UnknownKeyError, tuf.keydb.get_key, keyid3
        )
    ...
    def test_add_key(self):
        ...
        self.assertRaises(
            securesystemslib.exceptions.Error, tuf.keydb.add_key, rsakey, keyid2
        )
        self.assertRaises(
            securesystemslib.exceptions.Error, tuf.keydb.add_key, rsakey2, keyid
        )
        ...
        self.assertRaises(
            tuf.exceptions.KeyAlreadyExistsError, tuf.keydb.add_key, rsakey
        )
        self.assertRaises(
            tuf.exceptions.KeyAlreadyExistsError, tuf.keydb.add_key, rsakey2
        )
    ...
    def test_remove_key(self):
        ...
        self.assertRaises(
            tuf.exceptions.UnknownKeyError, tuf.keydb.get_key, keyid
        )
        self.assertRaises(
            tuf.exceptions.UnknownKeyError, tuf.keydb.get_key, keyid2
        )

        # Test for 'keyid' not in keydb.
        self.assertRaises(
            tuf.exceptions.UnknownKeyError, tuf.keydb.remove_key, keyid
        )

        # Test condition for unknown key argument.
        self.assertRaises(
            tuf.exceptions.UnknownKeyError, tuf.keydb.remove_key, "1"
        )
        ...
        self.assertRaises(
            securesystemslib.exceptions.FormatError, tuf.keydb.remove_key, None
        )
        self.assertRaises(
            securesystemslib.exceptions.FormatError, tuf.keydb.remove_key, ""
        )
        self.assertRaises(
            securesystemslib.exceptions.FormatError, tuf.keydb.remove_key, 123
        )
        self.assertRaises(
            securesystemslib.exceptions.FormatError,
            tuf.keydb.remove_key,
        ...
        self.assertRaises(
            securesystemslib.exceptions.Error, tuf.keydb.remove_key, rsakey3
        )
    ...
    def test_create_keydb_from_root_metadata(self):
        ...
        self.assertEqual(
            None, tuf.keydb.create_keydb_from_root_metadata(root_metadata)
        )
