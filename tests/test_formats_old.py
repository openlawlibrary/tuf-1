...
class TestFormats(unittest.TestCase):
    ...
    def test_schemas(self):
        ...
        valid_schemas = {
            ...
            "TARGETS_FILEINFO_SCHEMA": (
                tuf.formats.TARGETS_FILEINFO_SCHEMA,
                {
                    "length": 1024,
            ...
            "METADATA_FILEINFO_SCHEMA": (
                tuf.formats.METADATA_FILEINFO_SCHEMA,
                {
                    "length": 1024,
                    "hashes": {"sha256": "A4582BCF323BCEF"},
                    "version": 1,
            ...
            "SIGNATURE_SCHEMA": (
                ...
                {"keyid": "123abc", "sig": "A4582BCF323BCEF"},
            ),
            "SIGNATURESTATUS_SCHEMA": (
                tuf.formats.SIGNATURESTATUS_SCHEMA,
                {
                    "threshold": 1,
                    "good_sigs": ["123abc"],
                    "bad_sigs": ["123abc"],
            ...
            "RECEIVECONFIG_SCHEMA": (
                tuf.formats.RECEIVECONFIG_SCHEMA,
                {
                    "general": {
                        "transfer_module": "scp",
                        "pushroots": ["/pushes"],
            ...
            "MIRROR_SCHEMA_NO_CONFINED_TARGETS": (
                tuf.formats.MIRROR_SCHEMA,
                {
                    "url_prefix": "http://localhost:8001",
                    "metadata_path": "metadata/",
    ...
    def test_specfication_version_schema(self):
        ...
        for invalid_schema in invalid_schemas:
            self.assertFalse(
                tuf.formats.SPECIFICATION_VERSION_SCHEMA.matches(
                    invalid_schema
                ),
    ...
    def test_build_dict_conforming_to_schema(self):
        ...
        self.assertTrue(
            tuf.formats.TIMESTAMP_SCHEMA.matches(  # neither
                tuf.formats.build_dict_conforming_to_schema(
                    tuf.formats.TIMESTAMP_SCHEMA,
                    version=version,
                    expires=expires,
        ...
        self.assertTrue(
            tuf.formats.TIMESTAMP_SCHEMA.matches(  # one
                tuf.formats.build_dict_conforming_to_schema(
                    tuf.formats.TIMESTAMP_SCHEMA,
                    spec_version=spec_version,
                    version=version,
        ...
        self.assertTrue(
            tuf.formats.TIMESTAMP_SCHEMA.matches(  # the other
                tuf.formats.build_dict_conforming_to_schema(
                    tuf.formats.TIMESTAMP_SCHEMA,
                    _type="timestamp",
                    version=version,
        ...
        self.assertTrue(
            tuf.formats.ROOT_SCHEMA.matches(
                tuf.formats.build_dict_conforming_to_schema(
                    tuf.formats.ROOT_SCHEMA,
                    _type="root",
                    spec_version=spec_version,
        ...
        self.assertTrue(
            tuf.formats.SNAPSHOT_SCHEMA.matches(
                tuf.formats.build_dict_conforming_to_schema(
                    tuf.formats.SNAPSHOT_SCHEMA,
                    _type="snapshot",
                    spec_version=spec_version,
        ...
        self.assertTrue(
            tuf.formats.TARGETS_SCHEMA.matches(
                tuf.formats.build_dict_conforming_to_schema(
                    tuf.formats.TARGETS_SCHEMA,
                    _type="targets",
                    spec_version=spec_version,
    ...
    def test_unix_timestamp_to_datetime(self):
        ...
        self.assertTrue(
            datetime.datetime, tuf.formats.unix_timestamp_to_datetime(499137720)
        )
        datetime_object = datetime.datetime(1985, 10, 26, 1, 22)
        self.assertEqual(
            datetime_object, tuf.formats.unix_timestamp_to_datetime(499137720)
        )

        # Test conditions for invalid arguments.
        self.assertRaises(
            securesystemslib.exceptions.FormatError,
            tuf.formats.unix_timestamp_to_datetime,
            "bad",
        )
        self.assertRaises(
            securesystemslib.exceptions.FormatError,
    ...
    def test_datetime_to_unix_timestamp(self):
        ...
        self.assertEqual(
            1445455680, tuf.formats.datetime_to_unix_timestamp(datetime_object)
        )
    ...
    def test_format_base64(self):
        ...
        self.assertEqual(
            "dXBkYXRlZnJhbWV3b3Jr", tuf.formats.format_base64(data)
        )
    ...
    def test_make_signable(self):
        ...
        self.assertTrue(
            SIGNABLE_SCHEMA.matches(tuf.formats.make_signable(root))
        )
        signable = tuf.formats.make_signable(root)
        self.assertEqual(
            "root", tuf.formats.check_signable_object_format(signable)
        )
        ...
        self.assertTrue(
            SIGNABLE_SCHEMA.matches(tuf.formats.make_signable("123"))
        )
    ...
    def test_make_targets_fileinfo(self):
        ...
        self.assertTrue(
            TARGETS_FILEINFO_SCHEMA.matches(
                make_targets_fileinfo(length, hashes, custom)
            )
        )
        self.assertTrue(
            TARGETS_FILEINFO_SCHEMA.matches(
                make_targets_fileinfo(length, hashes)
            )
        )
    ...
    def test_make_metadata_fileinfo(self):
        ...
        self.assertTrue(
            METADATA_FILEINFO_SCHEMA.matches(
                make_metadata_fileinfo(version, length, hashes)
            )
        )
        self.assertTrue(
            METADATA_FILEINFO_SCHEMA.matches(make_metadata_fileinfo(version))
        )
    ...
    def test_make_versioninfo(self):
        ...
        self.assertTrue(
            VERSIONINFO_SCHEMA.matches(make_versioninfo(version_number))
        )
    ...
    def test_expected_meta_rolename(self):
        ...
        # Test conditions for invalid arguments.
        self.assertRaises(
            securesystemslib.exceptions.FormatError, expected_rolename, 123
        )
        self.assertRaises(
            securesystemslib.exceptions.FormatError,
            expected_rolename,
        ...
        self.assertRaises(
            securesystemslib.exceptions.FormatError, expected_rolename, True
        )
    ...
    def test_check_signable_object_format(self):
        ...
        self.assertRaises(
            securesystemslib.exceptions.FormatError, check_signable, "root"
        )
        self.assertRaises(
            securesystemslib.exceptions.FormatError, check_signable, 123
        )
        self.assertRaises(
            securesystemslib.exceptions.FormatError,
            check_signable,
        ...
        self.assertRaises(
            securesystemslib.exceptions.FormatError, check_signable, True
        )
